...
FILES=(
  ...
  "CLX/cascadelakex_core_v1.15.json"
  "CLX/cascadelakex_fp_arith_inst_v1.15.json"
  "CLX/cascadelakex_uncore_v1.15.json"
  "CLX/cascadelakex_uncore_v1.15_experimental.json"
  ...
  "SKX/skylakex_core_v1.27.json"
  "SKX/skylakex_fp_arith_inst_v1.27.json"
  "SKX/skylakex_matrix_bit_definitions_v1.27.json"
  "SKX/skylakex_matrix_v1.27.json"
  "SKX/skylakex_uncore_v1.27.json"
  "SKX/skylakex_uncore_v1.27_experimental.json"
